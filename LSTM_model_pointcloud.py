...
# Launch the graph
#六维特征及标签载入
f = open('/Users/Fangyu/Documents/GitHub/Large_Scale_3D_Scene_Recognition_CVPR2017/codes_learning_notes/LSTM_model_pointcloud/beam_1.txt', 'r')
train_data=[]
train_labels=[]
for line in f:
    line=line.split(' ')
...
f.close()
f = open('/Users/Fangyu/Documents/GitHub/Large_Scale_3D_Scene_Recognition_CVPR2017/codes_learning_notes/LSTM_model_pointcloud/board_1.txt', 'r')
for line in f:
    line=line.split(' ')
    row=[]
    for item in line:
...
f = open('/Users/Fangyu/Documents/GitHub/Large_Scale_3D_Scene_Recognition_CVPR2017/codes_learning_notes/LSTM_model_pointcloud/board_3.txt', 'r')
for line in f:
    line=line.split(' ')
    row=[]
    for item in line:
...
f = open('/Users/Fangyu/Documents/GitHub/Large_Scale_3D_Scene_Recognition_CVPR2017/codes_learning_notes/LSTM_model_pointcloud/bookcase_1.txt', 'r')
for line in f:
    line=line.split(' ')
    row=[]
    for item in line:
...
f = open('/Users/Fangyu/Documents/GitHub/Large_Scale_3D_Scene_Recognition_CVPR2017/codes_learning_notes/LSTM_model_pointcloud/ceiling_1.txt', 'r')
for line in f:
    line=line.split(' ')
    row=[]
    for item in line:
...
f = open('/Users/Fangyu/Documents/GitHub/Large_Scale_3D_Scene_Recognition_CVPR2017/codes_learning_notes/LSTM_model_pointcloud/chair_1.txt', 'r')
for line in f:
    line=line.split(' ')
    row=[]
    for item in line:
...
with tf.Session() as sess:
    ...
    f = open('/Users/Fangyu/Documents/GitHub/Large_Scale_3D_Scene_Recognition_CVPR2017/codes_learning_notes/LSTM_model_pointcloud/board_2.txt', 'r')
    test_data=[]
    test_label=[]
